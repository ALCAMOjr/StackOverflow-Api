...
pub async fn create_question(
    ...
    let result = questions_dao.create_question(question).await;

    match result {
        Ok(question_detail) => Ok(question_detail),
        Err(err) => {
...
pub async fn read_questions(
    ...
    let result = questions_dao.get_questions().await;
...
pub async fn create_answer(
    ...
    let result = answers_dao.create_answer(answer).await;
...
pub async fn read_answers(
    ...
    let result = answers_dao.get_answers(question_uuid.question_uuid).await;
